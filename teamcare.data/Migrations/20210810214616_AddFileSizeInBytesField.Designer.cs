...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210810214616_AddFileSizeInBytesField")]
    partial class AddFileSizeInBytesField
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("88610cfd-235d-497c-9930-9d5d4630468e"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 10, 21, 46, 15, 944, DateTimeKind.Unspecified).AddTicks(355), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("7fb974fc-6bcf-4302-b44b-f183d6f8ac1b"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 10, 21, 46, 15, 944, DateTimeKind.Unspecified).AddTicks(3258), new TimeSpan(0, 0, 0, 0, 0)),
