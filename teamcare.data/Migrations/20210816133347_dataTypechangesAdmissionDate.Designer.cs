...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210816133347_dataTypechangesAdmissionDate")]
    partial class dataTypechangesAdmissionDate
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ef466c47-483c-4f7b-b917-10899823074e"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 16, 13, 33, 46, 500, DateTimeKind.Unspecified).AddTicks(3910), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("3928eeab-7e18-464e-ae09-812889d74b70"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 16, 13, 33, 46, 500, DateTimeKind.Unspecified).AddTicks(4862), new TimeSpan(0, 0, 0, 0, 0)),
