...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210915081728_AssessmentAndAssessmentSkills")]
    partial class AssessmentAndAssessmentSkills
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("71468aff-3aa7-4ea5-8320-3c620f883152"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 15, 8, 17, 27, 809, DateTimeKind.Unspecified).AddTicks(9262), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("9ab1defa-5b9f-418e-9120-7973cd78445e"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 15, 8, 17, 27, 810, DateTimeKind.Unspecified).AddTicks(363), new TimeSpan(0, 0, 0, 0, 0)),
