...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210824083024_ServiceUserEnums")]
    partial class ServiceUserEnums
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2aea7ff6-f70c-4851-9272-5af20948d4d5"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 24, 8, 30, 23, 629, DateTimeKind.Unspecified).AddTicks(6307), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("df157b62-b838-4af4-805c-87b5ac6e7033"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 24, 8, 30, 23, 629, DateTimeKind.Unspecified).AddTicks(7609), new TimeSpan(0, 0, 0, 0, 0)),
