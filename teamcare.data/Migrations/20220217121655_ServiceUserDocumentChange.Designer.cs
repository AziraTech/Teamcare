...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20220217121655_ServiceUserDocumentChange")]
    partial class ServiceUserDocumentChange
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0384fbbb-80db-417c-ab8d-a5b014024d4d"),
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 2, 17, 12, 16, 54, 28, DateTimeKind.Unspecified).AddTicks(1839), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("e34af8cf-7a12-47cc-9bfa-8189b673f54e"),
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 2, 17, 12, 16, 54, 28, DateTimeKind.Unspecified).AddTicks(4269), new TimeSpan(0, 0, 0, 0, 0)),
