...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210807102326_ReferenceFields")]
    partial class ReferenceFields
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5320f930-2353-47f8-a656-eeb3c37e0019"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 7, 10, 23, 25, 485, DateTimeKind.Unspecified).AddTicks(4746), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("4136669d-7ee0-4983-a168-78e3a9738611"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 7, 10, 23, 25, 485, DateTimeKind.Unspecified).AddTicks(7007), new TimeSpan(0, 0, 0, 0, 0)),
