...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20211018072625_BloodPressureReadingTable")]
    partial class BloodPressureReadingTable
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ce48dc9d-e1ec-42d8-86e0-2c21900da2e1"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 18, 7, 26, 24, 622, DateTimeKind.Unspecified).AddTicks(6015), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("e5dfe669-d7f7-40ec-9311-72528f90f9b4"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 18, 7, 26, 24, 622, DateTimeKind.Unspecified).AddTicks(8017), new TimeSpan(0, 0, 0, 0, 0)),
