...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210818115135_UserReferenceToDocUpload")]
    partial class UserReferenceToDocUpload
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("709a111e-54a0-4f77-915b-ec6835c8cb09"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 18, 11, 51, 35, 42, DateTimeKind.Unspecified).AddTicks(7465), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("8850b38f-0747-44c9-b5cb-aef5e0aeee31"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 18, 11, 51, 35, 42, DateTimeKind.Unspecified).AddTicks(8349), new TimeSpan(0, 0, 0, 0, 0)),
