            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("20b3c10c-6f41-41a2-984e-425b7217e0b9"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 2, 6, 10, 47, 109, DateTimeKind.Unspecified).AddTicks(7134), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("6a91c03f-1159-40fa-b52d-277d8db14542"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 2, 6, 10, 47, 109, DateTimeKind.Unspecified).AddTicks(8228), new TimeSpan(0, 0, 0, 0, 0)),
