...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20220303093737_NewFieldServiceUserLogCategory")]
    partial class NewFieldServiceUserLogCategory
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d237dbf6-3aa1-4d09-b93c-7390d61ddfc1"),
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 3, 3, 9, 37, 36, 378, DateTimeKind.Unspecified).AddTicks(2136), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("ce3c8b44-0fe3-428a-8358-be7b23423e58"),
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 3, 3, 9, 37, 36, 378, DateTimeKind.Unspecified).AddTicks(3382), new TimeSpan(0, 0, 0, 0, 0)),
