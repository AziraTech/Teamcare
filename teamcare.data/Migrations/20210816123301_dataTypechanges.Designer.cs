...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210816123301_dataTypechanges")]
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("980ea54c-82e7-49d8-bfcf-cbdce023fe86"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 16, 12, 33, 1, 151, DateTimeKind.Unspecified).AddTicks(7088), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("00ee65a2-984e-437d-8081-550052014a94"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 16, 12, 33, 1, 151, DateTimeKind.Unspecified).AddTicks(8033), new TimeSpan(0, 0, 0, 0, 0)),
