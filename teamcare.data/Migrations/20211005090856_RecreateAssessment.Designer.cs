...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20211005090856_RecreateAssessment")]
    partial class RecreateAssessment
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0decb84b-c3bb-4c5e-bc6d-3444db34db3e"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 5, 9, 8, 55, 913, DateTimeKind.Unspecified).AddTicks(2925), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("2adbb50e-2bc3-403c-b764-2071b4c819a3"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 5, 9, 8, 55, 913, DateTimeKind.Unspecified).AddTicks(4977), new TimeSpan(0, 0, 0, 0, 0)),
