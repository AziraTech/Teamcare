...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210810213159_CreateDocumentUploadsTable")]
    partial class CreateDocumentUploadsTable
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3bb1937a-139c-4290-a07a-f05a51972ae3"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 10, 21, 31, 58, 600, DateTimeKind.Unspecified).AddTicks(9940), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("50169894-b899-4d3f-9a68-1b4ae54af835"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 10, 21, 31, 58, 601, DateTimeKind.Unspecified).AddTicks(2298), new TimeSpan(0, 0, 0, 0, 0)),
