...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20220218130511_UserRoleServiceUser")]
    partial class UserRoleServiceUser
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f59e32b-7c4d-4e52-b2c8-99b47916526d"),
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 2, 18, 13, 5, 10, 290, DateTimeKind.Unspecified).AddTicks(2456), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("0cb1e6ac-667b-435d-b5dd-6ec0ec900e76"),
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 2, 18, 13, 5, 10, 290, DateTimeKind.Unspecified).AddTicks(3802), new TimeSpan(0, 0, 0, 0, 0)),
