...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20211007092922_AddAssessmentOptionsGroup")]
    partial class AddAssessmentOptionsGroup
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.SkillAssessments.SkillGroup", b =>
                {
                    ...
                    b.Property<int>("AssessmentOptionsGroup")
                        .HasColumnType("integer")
                        .HasColumnName("assessment_optionsgroup");
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6b886751-9c18-4ec5-bb2e-046178d2abbc"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 7, 9, 29, 20, 498, DateTimeKind.Unspecified).AddTicks(6186), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("50cb9e01-12ae-456f-ad0b-c52bb6c3e1c1"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 7, 9, 29, 20, 499, DateTimeKind.Unspecified).AddTicks(2695), new TimeSpan(0, 0, 0, 0, 0)),
