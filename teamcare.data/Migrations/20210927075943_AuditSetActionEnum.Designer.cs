...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210927075943_AuditSetActionEnum")]
    partial class AuditSetActionEnum
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("492875ef-ae2d-4de0-9339-e2982df7de14"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 27, 7, 59, 40, 960, DateTimeKind.Unspecified).AddTicks(6369), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("9cbd34f3-df4f-43fe-b0f4-0fe06428f252"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 27, 7, 59, 40, 961, DateTimeKind.Unspecified).AddTicks(1235), new TimeSpan(0, 0, 0, 0, 0)),
