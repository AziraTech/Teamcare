...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210924131048_ChangeMiscellaneousPoints")]
    partial class ChangeMiscellaneousPoints
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1e85a93b-9571-4ca5-b246-0d658f2fc25d"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 24, 13, 10, 48, 62, DateTimeKind.Unspecified).AddTicks(7798), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("ce9a7ff8-eedb-46cd-80b9-ab9569df0413"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 24, 13, 10, 48, 62, DateTimeKind.Unspecified).AddTicks(9628), new TimeSpan(0, 0, 0, 0, 0)),
