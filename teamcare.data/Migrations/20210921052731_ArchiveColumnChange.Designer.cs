...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210921052731_ArchiveColumnChange")]
    partial class ArchiveColumnChange
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0b748e48-9852-4c8e-918e-bbc9d0ebbb8c"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 21, 5, 27, 30, 648, DateTimeKind.Unspecified).AddTicks(5518), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("e1142b3b-0cc5-4157-8929-4c329dc1a9e9"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 21, 5, 27, 30, 648, DateTimeKind.Unspecified).AddTicks(6850), new TimeSpan(0, 0, 0, 0, 0)),
