...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210812154746_AddTemporaryFlag")]
    partial class AddTemporaryFlag
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("76760cce-cae0-4169-940e-78fdd92ff3d2"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 12, 15, 47, 45, 658, DateTimeKind.Unspecified).AddTicks(4902), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("144f258e-c752-45cb-802d-9e5895b9990c"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 12, 15, 47, 45, 658, DateTimeKind.Unspecified).AddTicks(7560), new TimeSpan(0, 0, 0, 0, 0)),
