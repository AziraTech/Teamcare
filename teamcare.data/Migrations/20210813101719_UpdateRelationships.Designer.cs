...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210813101719_UpdateRelationships")]
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("185fb9d9-8c8c-4efe-9b9d-00d8f0c166d1"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 13, 10, 17, 18, 590, DateTimeKind.Unspecified).AddTicks(1644), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("f3f23af1-3275-4141-8b0b-1ae283505651"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 13, 10, 17, 18, 590, DateTimeKind.Unspecified).AddTicks(4007), new TimeSpan(0, 0, 0, 0, 0)),
