...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20220304134239_ServiceUserFieldAbsentFromResidence")]
    partial class ServiceUserFieldAbsentFromResidence
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.ServiceUser", b =>
                {
                    ...
                    b.Property<bool>("AbsentFromResidence")
                        .HasColumnType("boolean")
                        .HasColumnName("absent_from_residence");
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d8aae711-1372-4aed-bf5f-c18683f8b44c"),
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 3, 4, 13, 42, 38, 591, DateTimeKind.Unspecified).AddTicks(5802), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("1eb38aff-dcda-42c6-89dc-e19bd6f87249"),
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 3, 4, 13, 42, 38, 591, DateTimeKind.Unspecified).AddTicks(8125), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("teamcare.data.Entities.ServiceUser", b =>
                {
                    b.HasOne("teamcare.data.Entities.User", "CreatedByUser")
                        .WithOne()
                        .HasForeignKey("teamcare.data.Entities.ServiceUser", "CreatedBy");
