...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210907130627_ChangeTitleFieldOfUser")]
    partial class ChangeTitleFieldOfUser
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9dcb0620-6d06-4ad4-99d6-9fbac1ffa019"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 7, 13, 6, 27, 108, DateTimeKind.Unspecified).AddTicks(6506), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("325e1974-1e43-49e4-8689-18a2aadac4c0"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 7, 13, 6, 27, 108, DateTimeKind.Unspecified).AddTicks(7657), new TimeSpan(0, 0, 0, 0, 0)),
