...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210812161421_UpdateFields")]
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9f88835c-06d1-42d6-b530-1f04313a0b14"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 12, 16, 14, 21, 228, DateTimeKind.Unspecified).AddTicks(555), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("a68ec5e5-dde3-4de1-9dff-1ca13e541228"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 8, 12, 16, 14, 21, 228, DateTimeKind.Unspecified).AddTicks(3711), new TimeSpan(0, 0, 0, 0, 0)),
