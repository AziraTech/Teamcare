...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20211005094600_AddRiskAssessmentLevel")]
    partial class AddRiskAssessmentLevel
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9ad2c96c-d6e8-4a45-8a44-497b5535534c"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 5, 9, 45, 58, 570, DateTimeKind.Unspecified).AddTicks(9401), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("e2012571-d6ca-414c-acfd-a19e6a7c9adf"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 10, 5, 9, 45, 58, 571, DateTimeKind.Unspecified).AddTicks(4322), new TimeSpan(0, 0, 0, 0, 0)),
