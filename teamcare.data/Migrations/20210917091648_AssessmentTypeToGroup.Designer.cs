...
namespace teamcare.data.Migrations
{
    ...
    [Migration("20210917091648_AssessmentTypeToGroup")]
    partial class AssessmentTypeToGroup
    {
            ...
            modelBuilder.Entity("teamcare.data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("124a8175-388c-45ce-853d-a6fabe25831b"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 17, 9, 16, 47, 542, DateTimeKind.Unspecified).AddTicks(9151), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("3ab28e10-ae92-4a2c-84af-2155be61a74d"),
                            CreatedOn = new DateTimeOffset(new DateTime(2021, 9, 17, 9, 16, 47, 543, DateTimeKind.Unspecified).AddTicks(1653), new TimeSpan(0, 0, 0, 0, 0)),
