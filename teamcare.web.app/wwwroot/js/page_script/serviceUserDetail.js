...
$(document).ready(function () {
    ...
    $('#tabdocumentsmanager').click(function () {
        $.ajax({
            type: "GET",
            url: '/ServiceUsers/DocumentTabBind',
            ...
            success: function (data) {
                if (data != null) {
                    ...
                    setCurrentTabDocument($('#hdndocumenttab').val());
                }
            }
        });
    });
...
async function setCurrentTabDocument(id) {
    var serviceUserId = $('#hdnserviceuserid').val();

    $.ajax({
        type: "GET",
        url: '/ServiceUsers/DocumentCategoryBind',
        data: { catId: id, serviceUserId: serviceUserId },
        success: function (data) {
...
async function sendServiceUserDocument(dbType, docId) {
    ...
    var IsConfidental = $('#chkuIsConfiDoc').prop('checked');
